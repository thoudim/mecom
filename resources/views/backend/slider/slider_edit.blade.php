					...
					<div class="card">
						<div class="card-body">
							<form id="myForm" method="POST" action="{{ route('update.slider') }}" enctype="multipart/form-data">
								...
								<input type="hidden" name="old_name" class="form-control" value="{{ $slider->slider_image }}" />
								<div class="row mb-3">
									<div class="col-sm-3">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
										<img id="showImage" src="{{ (!empty($slider->slider_image)) ? url($slider->slider_image) : url('upload/no_image.jpg') }}" alt="Slider Image" style="width: 100px; height: 100px;">
									</div>
								</div>
								<div class="row">
