...
<div class="page-content">
	...
	<!--end breadcrumb-->
	<h6 class="mb-0 text-uppercase">List Banner</h6>
	<hr/>
	<div class="card">
		<div class="card-body">
				...
				<table id="brandTable" class="table table-striped table-bordered" style="width:100%">
					...
					<tbody>
						...
						<tr>
							...
							<td> <img src="{{ (!empty($banner->banner_image)) ? url($banner->banner_image) : url('upload/no_image.jpg')}}" style="width: 70px;"></td>
							<td>
								<a href="{{ route('edit.banner', $banner->id) }}" class="btn btn-info">Edit</a>
								<a href="{{ route('delete.banner', $banner->id) }}" id="delete" class="btn btn-danger">Delete</a>
							</td>
						</tr>	
						@endforeach					
					</tbody>
