					...
					<div class="card">
						<div class="card-body">
							<form id="myForm" method="POST" action="{{ route('update.banner') }}" enctype="multipart/form-data">
								...
								<input type="hidden" name="old_name" class="form-control" value="{{ $banner->banner_image }}" />
								<div class="row mb-3">
									<div class="col-sm-3">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
										<img id="showImage" src="{{ (!empty($banner->banner_image)) ? url($banner->banner_image) : url('upload/no_image.jpg') }}" alt="Banner Image" style="width: 100px; height: 100px;">
									</div>
								</div>
								<div class="row">
