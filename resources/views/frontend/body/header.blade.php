        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                <div class="logo logo-width-1 d-block d-lg-none">
                    <a href="{{ route('dashboard') }}"><img src="{{ asset('frontend/assets/imgs/theme/logo.svg') }}" alt="logo" /></a>
                </div>
        ...
        <div class="mobile-header-content-area">
                ...
                <nav>
                    <ul class="mobile-menu font-heading">
                        <li class="menu-item-has-children">                            
                            @auth
                            <a href="{{ route('frontend.home_page') }}">Home</a>
                            @else 
            ...
            <div class="mobile-header-info-wrap">
                ...
                <div class="single-mobile-header-info">
                    ...
                    <a href="{{ route('login') }}"><i class="fi fi-rs-user"></i> Login </a>
                </div>
                <div class="single-mobile-header-info">                    
                    <a href="{{ route('register') }}"><i class="fi fi-rs-user-add"></i> Register </a>
                </div>
                @endauth
                <div class="single-mobile-header-info">
