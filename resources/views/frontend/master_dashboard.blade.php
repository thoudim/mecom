...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/assets/css/plugins/toastr.css') }}" >
...
<body>
    ...
    <script type="text/javascript" src="{{ asset('frontend/assets/js/plugins/toastr.min.js') }}"></script>
    ...
    <script type="text/javascript">
        ...
        function addToCart(){
            ...
            $.ajax({
                ...
                dataType: 'json',
                data:{
                    color:color, size:color, quantity:quantity, product_name:product_name, vendor:vendor
                },
                ...
                success:function(response){
                    ...
                    $.each(response.compare, function(key,value){
                        rows +=`<tr class="pr_image">
                                    ...
                                    <td class="row_img"><img src="/${value.product.product_thambnail}" alt="compare-img" /></td>
