							...
							<form method="POST" action="{{ route('vendor.profile.store') }}" enctype="multipart/form-data">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-9 text-secondary">
										...
										<input type="text" name="vendor_join" class="form-control datepicker picker__input" readonly="" id="vendor_join" aria-haspopup="true" aria-readonly="false" aria-owns="P980394900_root" value="{{ $vendorData->vendor_join }}">
									</div>
								</div>
								<div class="row mb-3">
									<div class="col-sm-3">
									...
									<div class="col-sm-9 text-secondary">
										<!-- <input type="text" name="vendor_short_info" class="form-control" value="{{ $vendorData->vendor_short_info }}" /> -->
										<textarea class="form-control" name="vendor_short_info" id="vendor_short_info" placeholder="Address..." rows="3">{{ $vendorData->vendor_short_info }}</textarea>
									</div>
								</div>
								<div class="row mb-3">
									<div class="col-sm-3">
