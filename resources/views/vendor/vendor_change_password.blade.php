										...
										<form method="POST" action="{{ route('vendor.update.password') }}">
											...
											<div class="row mb-3">
												...
												<div class="col-sm-9 text-secondary">
													...
													<div class="input-group"> 
														...
														<input type="password" name="new_password" class="form-control border-start-0 @error('old_password') is-invalid @enderror" id="new_password" placeholder="Old Password">
													</div>
													@error('new_password')
													<span class="text-danger">{{ $message }}</span>
													@enderror
											...
											<div class="row mb-3">
												...
												<div class="col-sm-9 text-secondary">
													...
													<div class="input-group"> 
														<span class="input-group-text bg-transparent"><i class="bx bxs-lock-open"></i></span>
														<input type="password" name="new_password_confirmation" class="form-control border-start-0" id="new_password_confirmation" placeholder="Old Password">
													</div>
												</div>
											</div>
